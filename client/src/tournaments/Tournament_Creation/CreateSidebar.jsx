...
function CreateSidebar({
    ...
    return (
        <>
            <div className="grid gap-10 justify-center p-5 bg-card w-full h-screen sticky top-0">
                <div className='flex flex-col gap-1 w-full text-center '>                    
                    <img className=' w-full' src="https://res.cloudinary.com/dwaaoyztz/image/upload/v1784428720/FIERZIO.gg_3_-Photoroom_npjprr.png" alt="" />
