...
function Header() {
    return (
        <>
            <main className='w-full flex justify-center items-center fixed top-0 z-12 ' >
                ...
                <section className='w-9/10 flex justify-between items-center backdrop-blur-xl bg-[rgba(0,0,0,0.5)] my-5 py-3 rounded-3xl px-10' >
                    <img src="https://res.cloudinary.com/dwaaoyztz/image/upload/v1784392713/FIERZIO.gg_2_-Photoroom_o7mwm8.png" className='h-15' alt="" />
