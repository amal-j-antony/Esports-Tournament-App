    ...
    return (
        <>
            <main className={`w-full flex justify-center items-center  top-0 z-12 bg-card mb-1 `} >
                ...
                <section className={`w-full flex justify-between items-center backdrop-blur-xl  py-1 rounded-3xl px-10  `} >
                    ...
                    <ul className="flex items-center font-bold gap-2">
                        <Link to={"/tournaments"} className='text-xl cursor-pointer hover:bg-accent-foreground p-3 rounded-2xl duration-500 flex gap-2 items-center' ><TrophyIcon/> Tournaments</Link>
                        <Link to={"/lederboard"} className='text-xl cursor-pointer hover:bg-accent-foreground p-3 rounded-2xl duration-500 flex gap-2 items-center' ><MdLeaderboard />Leaderboard</Link>
                        <Link to={"/user/1/clans"} className='text-xl cursor-pointer hover:bg-accent-foreground p-3 rounded-2xl duration-500 flex gap-2 items-center' ><FaPeopleGroup/>Clans</Link>
                        <li className='text-xl cursor-pointer hover:bg-accent-foreground p-3 rounded-2xl duration-500 flex gap-2 items-center' ><FaUserGroup/>Squads</li>
                    </ul>
                    <>
